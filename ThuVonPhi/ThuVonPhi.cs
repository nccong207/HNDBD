...
namespace ThuVonPhi
{
    public class ThuVonPhi:ICControl
    {
        ...
        public void AddEvent()
        {
            ...
            txtSoThangThu = data.FrmMain.Controls.Find("SoThangThu", true)[0] as TextEdit;
            txtSoThangThu.KeyPress += new KeyPressEventHandler(txtSoThangThu_KeyPress);
        ...
        void txtSoThangThu_KeyPress(object sender, KeyPressEventArgs e)
        {
...
//            }
        ...
        { 
            ...
            foreach (DataRow dr in dtHoVay.Rows)
            {
                ...
                int sttp = txtSoThangThu.Text != "" ? int.Parse(txtSoThangThu.EditValue.ToString()) : 3;
                // Số tháng: mặc định = 3
